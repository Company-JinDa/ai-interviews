...
const styles = {
  global: (props: any) => ({
    ...
    // Giữ tone dịu hơn cho tab đang active
...
const colors = {
  brand: {
    ...
    200: "#9FD0FF",
    300: "#6AB7FF",
    400: "#4299E1", // hơi tươi hơn xanh chủ đạo
    500: "#3182CE",
    600: "#2B6CB0",
    700: "#265A8F",
  },
  accent: {
    mint: "#E6FFFA", // pastel mint
    blueSoft: "#F0F8FF", // nền nhạt hơn chút
    graySoft: "#F5F7FB",
  },
  bgSoft: "#F5F7FB",
  textSoft: "#2D3748",
